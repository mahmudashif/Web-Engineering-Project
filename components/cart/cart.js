...
function renderOrders(orders) {
    ...
    orders.forEach(order => {
        ...
        const moreItemsText = order.items.length > 3 ? 
            `<p style="text-align: center; color: #718096; font-size: 0.8rem; margin-top: 8px;">
            ...
            <div class="order-card">
                ...
                <div class="order-details">
                    ...
                    <div class="order-summary-info">
                        ...
                        <div style="font-size: 0.8rem; color: #718096; text-align: right;">
...
function viewOrderDetails(orderId) {
    showInfo(`Viewing details for order #${orderId} (Feature to be implemented)`);
}

// Track order (placeholder function)  
function trackOrder(orderId) {
    showInfo(`Tracking order #${orderId} (Feature to be implemented)`);
}
